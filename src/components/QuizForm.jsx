...
const QuizForm = () => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                const response = await axios.get(`https://quizappbackend-4aj2.onrender.com/quiz/${quizName}`); // ✅ Store response
                setQuestions(response.data.questions); // ✅ Use response correctly
            } catch (error) {
